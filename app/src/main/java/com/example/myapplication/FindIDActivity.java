...
public class FindIDActivity extends AppCompatActivity {
    ...
    class FindIdRunnable implements Runnable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fidname = (EditText)findViewById(R.id.fidname);
        btn_gofid = (Button)findViewById(R.id.btn_gofid);
        ...
        btn_gofid.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void findSuccessDialog(String result) {
        ...
        alert.setMessage("아이디는 " + result + " 입니다." + "\n" + " 로그인 페이지로 이동합니다.");
        alert.show();
    }
